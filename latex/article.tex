...
The PLOS Open Science Indicators dataset (v10, corpus through March 2025; approximately 139{,}000 PLOS plus 28{,}000 comparator articles) provides a contemporary external benchmark, derived from a JATS XML pipeline operated by DataSeer~\cite{PLOS2025-zb}. The continued use of JATS-XML-only pipelines in widely cited benchmarks underscores the value of the PDF-first approach we adopt here.
